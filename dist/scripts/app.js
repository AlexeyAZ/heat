...
var scrollMonitor = __webpack_require__(327);
var MobileDetect = __webpack_require__(328);
...
var app = {
	...
	bindEvents: function bindEvents() {
		...
		function chaoticMove() {
			var pEl = document.querySelectorAll('[data-parallaxify-range-x]');

			function move(el) {
				var elX = getCoords(el).left;
			...
			function start() {
				...
				[].concat(_toConsumableArray(pEl)).forEach(function (el) {
		...
		function scrollPage(options) {
			...
			var watchers = [].concat(_toConsumableArray(sections)).map(function (element) {
		...
		function createOptionsObj(options) {
			var totalSlider = document.querySelector('.agallery_1 .swiper-slide').length;
			var pagination = options.pagination === false ? '' : options.pagination;
			var autoplay = options.autoplay === undefined ? '' : 3000;
			var coverflow = options.coverflow;
		...
		var mySwiper1 = new Swiper('.agallery_1', createOptionsObj({ coverflow: true, autoplay: true, pagination: '.agallery__pagination_1' }));
		var mySwiper2 = new Swiper('.agallery_2', createOptionsObj({ coverflow: true, pagination: false }));
		var mySwiper3 = new Swiper('.agallery_3', createOptionsObj({ coverflow: true, pagination: '.agallery__pagination_3' }));

		mySwiper1.params.control = mySwiper3;
		// mySwiper3.params.control = mySwiper2;

		var galleryes = document.querySelectorAll('.agallery');
		[].concat(_toConsumableArray(galleryes)).forEach(function (gallery) {
			gallery.addEventListener('click', function (e) {

				var windowWidth = document.documentElement.clientWidth / 2;
				var clickXCoord = e.clientX;
